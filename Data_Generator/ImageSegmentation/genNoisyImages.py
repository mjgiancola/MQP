...
def saveImage(A, filename):
  ...
  for i in range(h):
    for j in range(w):
      ...
      elif lbl ==  5: img[i,j] = PINK
      elif lbl ==  6: img[i,j] = TAN
      elif lbl ==  7: img[i,j] = KHAKI
...
def generateCouple():
  im = skimage.io.imread("../ADE20K/Generated/couple/gt_seg.png", as_grey=True)
  ...
  saveImage(img, '../Simulation/Tests/ImageSegmentation/Images/couple/gt_seg.png')
  ...
  for i in range(10):
    ...
    saveImage(modifiedIm, '../Simulation/Tests/ImageSegmentation/Images/couple/noisy%d.png' % i)

def generateFlag():
  im = skimage.io.imread("../ADE20K/Generated/flag/gt_seg.png", as_grey=True)
  _, classIm = np.unique(im, return_inverse=True)

  img = classIm.reshape(im.shape)
  saveImage(img, '../Simulation/Tests/ImageSegmentation/Images/flag/gt_seg.png')
  ...
  for i in range(10):
    ...
    modifiedIm = bleed(permuted, numBleeds = 128)
    saveImage(modifiedIm, '../Simulation/Tests/ImageSegmentation/Images/flag/noisy%d.png' % i)

def generateLight():
  im = skimage.io.imread("../ADE20K/Generated/light/gt_seg.png", as_grey=True)
  _, classIm = np.unique(im, return_inverse=True)
  ...
  img = classIm.reshape(im.shape)
  saveImage(img, '../Simulation/Tests/ImageSegmentation/Images/light/gt_seg.png')
  ...
  for i in range(10):
    ...
    modifiedIm = bleed(permuted, numBleeds = 128)
    saveImage(modifiedIm, '../Simulation/Tests/ImageSegmentation/Images/light/noisy%d.png' % i)

def generatePeople():
  im = skimage.io.imread("../ADE20K/Generated/people/gt_seg.png", as_grey=True)
  _, classIm = np.unique(im, return_inverse=True)
  ...
  img = classIm.reshape(im.shape)
  saveImage(img, '../Simulation/Tests/ImageSegmentation/Images/people/gt_seg.png')
  ...
  for i in range(10):
    ...
    # Had to modify since the image is so small
    modifiedIm = bleed(permuted, kernelSize=4, numBleeds = 128)
    saveImage(modifiedIm, '../Simulation/Tests/ImageSegmentation/Images/people/noisy%d.png' % i)
